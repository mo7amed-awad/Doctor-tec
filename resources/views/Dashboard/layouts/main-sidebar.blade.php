		...
		<aside class="app-sidebar sidebar-scroll">
			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					...
					<li class="slide">
						<a class="side-menu__item" href="{{route('home')}}"><span class="side-menu__label">الصفحة الرئيسية</span></a>
					</li>
					<li class="side-item side-item-category">البيانات</li>
					<li class="slide">
						<a class="side-menu__item" href="{{ route('users') }}"><span class="side-menu__label">المستخدمين</span></a>
					</li>
					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><span class="side-menu__label">الأطباء</span><i class="angle fe fe-chevron-down"></i></a>
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ route('waited_doctors') }}">الطلبات</a></li>
							<li><a class="slide-item" href="{{ route('acceptable_doctors') }}">الأطباء المقبولون</a></li>
						</ul>
					</li>
					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><span class="side-menu__label">الصيادلة</span><i class="angle fe fe-chevron-down"></i></a>
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ route('waited_pharmacists') }}">الطلبات</a></li>
							<li><a class="slide-item" href="{{ route('acceptable_pharmacists') }}">الصيادلة المقبولون</a></li>
						</ul>
					</li>
