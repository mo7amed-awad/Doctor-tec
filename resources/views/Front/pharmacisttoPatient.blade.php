...
<body>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    {{ $diagnosis->treatment }}
                                                    @else
                                                    <button class="btn" data-bs-toggle="modal" data-bs-target="#modal" id="btnfour"style="background-color: rgb(6 163 218) !important ; color:white;padding:10px 15px "data-diagnosis-id="{{ $diagnosis->id }}">إضافة دواء</button>
                                                    @endif
                                                </td>
                                                <td>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div>
                                    <form id="treatmentForm" method="POST" action="{{ route('updateTreatment') }}">
                                        @csrf
                                        <input type="hidden" name="diagnosis_id" id="diagnosisId" value={{12}}>
                                        <div class="mb-5 passwordDiv">
                                            <label class="form-label" for="password" style="font-size: 18px; color: #091e3e;"> الدواء</label>
                                            <div class="d-flex align-center justify-content-between align-content-center p-relative">
                                                <input class="form-control" type="text" name="treatment" id="password"  />
                                            </div>
                                        </div>
                                        <div class="d-flex align-items-center justify-content-center">
                                            <button class="btn btn-primary text-white" type="submit" id="submit">إضافة الدواء</button>
                                        </div>
                                        </form>
                                    </div>
                                </div>
    ...
    <script>
        ...
        treatmentModal.addEventListener('show.bs.modal', function(event) {
            ...
            var diagnosisId = button.getAttribute('data-diagnosis-id'); // Extract info from data-* attributes
            var modalBodyInput = treatmentModal.querySelector('.modal-body input#diagnosisId');
            modalBodyInput.value = diagnosisId;
        });
    </script>
    <!-- JavaScript -->
